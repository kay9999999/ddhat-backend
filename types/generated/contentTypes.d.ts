...
export interface ApiContactUsContactUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    mapEmbedLink: Schema.Attribute.Text;
...
export interface ApiContentManageContentManage extends Struct.SingleTypeSchema {
  collectionName: 'content_manages';
  info: {
    displayName: 'Content-manage';
    pluralName: 'content-manages';
    singularName: 'content-manage';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    bannerimg: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    card: Schema.Attribute.Component<'components.feature', true>;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::content-manage.content-manage'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sectionheading: Schema.Attribute.String;
    sectionimg: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    sectionpoints: Schema.Attribute.Component<'components.points', true>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDatabaseDatabase extends Struct.SingleTypeSchema {
...
export interface ApiDigitalMarketingDigitalMarketing
  ...
  attributes: {
    ...
    card: Schema.Attribute.Component<'components.feature', true>;
    cardheading: Schema.Attribute.String;
    cardsubheading: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    ...
    > &
      Schema.Attribute.Private;
    mainheading: Schema.Attribute.String;
    mainpoints: Schema.Attribute.Component<'components.points', true>;
    publishedAt: Schema.Attribute.DateTime;
    sectionheading: Schema.Attribute.String;
    sectionimg: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<['layout.slider', 'layout.features']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
...
export interface ApiJobPositionJobPosition extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    noofpositions: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMobileAppDevMobileAppDev extends Struct.SingleTypeSchema {
  collectionName: 'mobile_app_devs';
  info: {
    displayName: 'Mobile-App-Dev';
    pluralName: 'mobile-app-devs';
    singularName: 'mobile-app-dev';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::mobile-app-dev.mobile-app-dev'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sectionheading: Schema.Attribute.String;
...
export interface ApiPhpDevPhpDev extends Struct.SingleTypeSchema {
  collectionName: 'php_devs';
  info: {
    displayName: 'PHP-Dev';
    pluralName: 'php-devs';
    singularName: 'php-dev';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    mainheading: Schema.Attribute.String;
    mainpoints: Schema.Attribute.Component<'components.points', true>;
    points1: Schema.Attribute.Component<'components.points', true>;
    publishedAt: Schema.Attribute.DateTime;
    sectionheading: Schema.Attribute.String;
    sectionimg: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
...
export interface ApiWebAppDevWebAppDev extends Struct.SingleTypeSchema {
  collectionName: 'web_app_devs';
  info: {
    description: '';
    displayName: 'Web-App-Dev';
    pluralName: 'web-app-devs';
    singularName: 'web-app-dev';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    bannerimg: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    card1: Schema.Attribute.Component<'components.feature', true>;
    card2: Schema.Attribute.Component<'components.feature', true>;
    card3: Schema.Attribute.Component<'components.feature', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::web-app-dev.web-app-dev'
    > &
      Schema.Attribute.Private;
    points: Schema.Attribute.Component<'components.points', true>;
    publishedAt: Schema.Attribute.DateTime;
    sectionheading: Schema.Attribute.String;
    sectionimg: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    sectionpoints: Schema.Attribute.Component<'components.points', true>;
    subhead1: Schema.Attribute.Text;
    subhead2: Schema.Attribute.Text;
    subsubhead1: Schema.Attribute.String;
    subsubhead2: Schema.Attribute.String;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiWebDevWebDev extends Struct.SingleTypeSchema {
  collectionName: 'web_devs';
  info: {
    description: '';
    displayName: 'Web-Dev';
    pluralName: 'web-devs';
    singularName: 'web-dev';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    sectionpoints: Schema.Attribute.Component<'components.points', true>;
    subhead1: Schema.Attribute.Text;
    subsubhead1: Schema.Attribute.Text;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::content-manage.content-manage': ApiContentManageContentManage;
      ...
      'api::mobile-app-dev.mobile-app-dev': ApiMobileAppDevMobileAppDev;
      'api::php-dev.php-dev': ApiPhpDevPhpDev;
      'api::post.post': ApiPostPost;
      'api::service.service': ApiServiceService;
      'api::support.support': ApiSupportSupport;
      'api::web-app-dev.web-app-dev': ApiWebAppDevWebAppDev;
      'api::web-design.web-design': ApiWebDesignWebDesign;
      'api::web-dev.web-dev': ApiWebDevWebDev;
